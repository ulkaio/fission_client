...
class IoFissionV1CanaryConfig(BaseModel):
    """
    ...
    spec: IoFissionV1CanaryConfigSpec
    status: IoFissionV1CanaryConfigStatus
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "spec": IoFissionV1CanaryConfigSpec.from_dict(obj.get("spec")) if obj.get("spec") is not None else None,
            "status": IoFissionV1CanaryConfigStatus.from_dict(obj.get("status")) if obj.get("status") is not None else None
        })
        return _obj
