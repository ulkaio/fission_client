...
class IoFissionV1Function(BaseModel):
    """
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "spec": IoFissionV1FunctionSpec.from_dict(obj.get("spec")) if obj.get("spec") is not None else None
        })
        return _obj
