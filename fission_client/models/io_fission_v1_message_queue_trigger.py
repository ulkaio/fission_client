...
class IoFissionV1MessageQueueTrigger(BaseModel):
    """
    ...
    spec: IoFissionV1MessageQueueTriggerSpec
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "spec": IoFissionV1MessageQueueTriggerSpec.from_dict(obj.get("spec")) if obj.get("spec") is not None else None
        })
        return _obj
