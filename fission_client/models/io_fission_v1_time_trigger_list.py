...
class IoFissionV1TimeTriggerList(BaseModel):
    """
    ...
    items: List[IoFissionV1TimeTrigger] = Field(description="List of timetriggers. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "items": [IoFissionV1TimeTrigger.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),
