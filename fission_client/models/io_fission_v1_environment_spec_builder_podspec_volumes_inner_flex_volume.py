...
class IoFissionV1EnvironmentSpecBuilderPodspecVolumesInnerFlexVolume(BaseModel):
    """
    ...
    secret_ref: Optional[IoFissionV1EnvironmentSpecBuilderPodspecVolumesInnerFlexVolumeSecretRef] = Field(default=None, alias="secretRef")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "secretRef": IoFissionV1EnvironmentSpecBuilderPodspecVolumesInnerFlexVolumeSecretRef.from_dict(obj.get("secretRef")) if obj.get("secretRef") is not None else None
        })
        return _obj
