...
class IoFissionV1EnvironmentSpecBuilderPodspecVolumesInnerCsi(BaseModel):
    """
    ...
    node_publish_secret_ref: Optional[IoFissionV1EnvironmentSpecBuilderPodspecVolumesInnerCsiNodePublishSecretRef] = Field(default=None, alias="nodePublishSecretRef")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "nodePublishSecretRef": IoFissionV1EnvironmentSpecBuilderPodspecVolumesInnerCsiNodePublishSecretRef.from_dict(obj.get("nodePublishSecretRef")) if obj.get("nodePublishSecretRef") is not None else None,
