...
class IoK8sApimachineryPkgApisMetaV1DeleteOptions(BaseModel):
    ...
    preconditions: Optional[IoK8sApimachineryPkgApisMetaV1Preconditions] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "preconditions": IoK8sApimachineryPkgApisMetaV1Preconditions.from_dict(obj.get("preconditions")) if obj.get("preconditions") is not None else None,
