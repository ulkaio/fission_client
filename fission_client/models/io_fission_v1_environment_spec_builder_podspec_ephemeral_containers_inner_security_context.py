...
class IoFissionV1EnvironmentSpecBuilderPodspecEphemeralContainersInnerSecurityContext(BaseModel):
    """
    ...
    app_armor_profile: Optional[IoFissionV1EnvironmentSpecBuilderContainerSecurityContextAppArmorProfile] = Field(default=None, alias="appArmorProfile")
    capabilities: Optional[IoFissionV1EnvironmentSpecBuilderContainerSecurityContextCapabilities] = None
    ...
    se_linux_options: Optional[IoFissionV1EnvironmentSpecBuilderContainerSecurityContextSeLinuxOptions] = Field(default=None, alias="seLinuxOptions")
    seccomp_profile: Optional[IoFissionV1EnvironmentSpecBuilderContainerSecurityContextSeccompProfile] = Field(default=None, alias="seccompProfile")
    windows_options: Optional[IoFissionV1EnvironmentSpecBuilderContainerSecurityContextWindowsOptions] = Field(default=None, alias="windowsOptions")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "appArmorProfile": IoFissionV1EnvironmentSpecBuilderContainerSecurityContextAppArmorProfile.from_dict(obj.get("appArmorProfile")) if obj.get("appArmorProfile") is not None else None,
            "capabilities": IoFissionV1EnvironmentSpecBuilderContainerSecurityContextCapabilities.from_dict(obj.get("capabilities")) if obj.get("capabilities") is not None else None,
            ...
            "seLinuxOptions": IoFissionV1EnvironmentSpecBuilderContainerSecurityContextSeLinuxOptions.from_dict(obj.get("seLinuxOptions")) if obj.get("seLinuxOptions") is not None else None,
            "seccompProfile": IoFissionV1EnvironmentSpecBuilderContainerSecurityContextSeccompProfile.from_dict(obj.get("seccompProfile")) if obj.get("seccompProfile") is not None else None,
            "windowsOptions": IoFissionV1EnvironmentSpecBuilderContainerSecurityContextWindowsOptions.from_dict(obj.get("windowsOptions")) if obj.get("windowsOptions") is not None else None
        })
        return _obj
