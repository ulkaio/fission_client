...
class IoFissionV1EnvironmentSpecBuilderPodspecVolumesInnerCinder(BaseModel):
    """
    ...
    secret_ref: Optional[IoFissionV1EnvironmentSpecBuilderPodspecVolumesInnerCinderSecretRef] = Field(default=None, alias="secretRef")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "secretRef": IoFissionV1EnvironmentSpecBuilderPodspecVolumesInnerCinderSecretRef.from_dict(obj.get("secretRef")) if obj.get("secretRef") is not None else None,
