...
class IoFissionV1EnvironmentSpecBuilderPodspecEphemeralContainersInner(BaseModel):
    """
    ...
    env: Optional[List[IoFissionV1EnvironmentSpecBuilderContainerEnvInner]] = Field(default=None, description="List of environment variables to set in the container. Cannot be updated.")
    env_from: Optional[List[IoFissionV1EnvironmentSpecBuilderContainerEnvFromInner]] = Field(default=None, description="List of sources to populate environment variables in the container. The keys defined within a source must be a C_IDENTIFIER. All invalid keys will be reported as an event when the container is starting. When a key exists in multiple sources, the value associated with the last source will take precedence. Values defined by an Env with a duplicate key will take precedence. Cannot be updated.", alias="envFrom")
    ...
    lifecycle: Optional[IoFissionV1EnvironmentSpecBuilderPodspecEphemeralContainersInnerLifecycle] = None
    liveness_probe: Optional[IoFissionV1EnvironmentSpecBuilderPodspecEphemeralContainersInnerLivenessProbe] = Field(default=None, alias="livenessProbe")
    ...
    ports: Optional[List[IoFissionV1EnvironmentSpecBuilderContainerPortsInner]] = Field(default=None, description="Ports are not allowed for ephemeral containers.")
    readiness_probe: Optional[IoFissionV1EnvironmentSpecBuilderPodspecEphemeralContainersInnerLivenessProbe] = Field(default=None, alias="readinessProbe")
    resize_policy: Optional[List[IoFissionV1EnvironmentSpecBuilderContainerResizePolicyInner]] = Field(default=None, description="Resources resize policy for the container.", alias="resizePolicy")
    resources: Optional[IoFissionV1EnvironmentSpecBuilderPodspecEphemeralContainersInnerResources] = None
    ...
    security_context: Optional[IoFissionV1EnvironmentSpecBuilderPodspecEphemeralContainersInnerSecurityContext] = Field(default=None, alias="securityContext")
    startup_probe: Optional[IoFissionV1EnvironmentSpecBuilderPodspecEphemeralContainersInnerLivenessProbe] = Field(default=None, alias="startupProbe")
    ...
    volume_devices: Optional[List[IoFissionV1EnvironmentSpecBuilderContainerVolumeDevicesInner]] = Field(default=None, description="volumeDevices is the list of block devices to be used by the container.", alias="volumeDevices")
    volume_mounts: Optional[List[IoFissionV1EnvironmentSpecBuilderContainerVolumeMountsInner]] = Field(default=None, description="Pod volumes to mount into the container's filesystem. Subpath mounts are not allowed for ephemeral containers. Cannot be updated.", alias="volumeMounts")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "env": [IoFissionV1EnvironmentSpecBuilderContainerEnvInner.from_dict(_item) for _item in obj.get("env")] if obj.get("env") is not None else None,
            "envFrom": [IoFissionV1EnvironmentSpecBuilderContainerEnvFromInner.from_dict(_item) for _item in obj.get("envFrom")] if obj.get("envFrom") is not None else None,
            "image": obj.get("image"),
            "imagePullPolicy": obj.get("imagePullPolicy"),
            "lifecycle": IoFissionV1EnvironmentSpecBuilderPodspecEphemeralContainersInnerLifecycle.from_dict(obj.get("lifecycle")) if obj.get("lifecycle") is not None else None,
            "livenessProbe": IoFissionV1EnvironmentSpecBuilderPodspecEphemeralContainersInnerLivenessProbe.from_dict(obj.get("livenessProbe")) if obj.get("livenessProbe") is not None else None,
            "name": obj.get("name"),
            "ports": [IoFissionV1EnvironmentSpecBuilderContainerPortsInner.from_dict(_item) for _item in obj.get("ports")] if obj.get("ports") is not None else None,
            "readinessProbe": IoFissionV1EnvironmentSpecBuilderPodspecEphemeralContainersInnerLivenessProbe.from_dict(obj.get("readinessProbe")) if obj.get("readinessProbe") is not None else None,
            "resizePolicy": [IoFissionV1EnvironmentSpecBuilderContainerResizePolicyInner.from_dict(_item) for _item in obj.get("resizePolicy")] if obj.get("resizePolicy") is not None else None,
            "resources": IoFissionV1EnvironmentSpecBuilderPodspecEphemeralContainersInnerResources.from_dict(obj.get("resources")) if obj.get("resources") is not None else None,
            "restartPolicy": obj.get("restartPolicy"),
            "securityContext": IoFissionV1EnvironmentSpecBuilderPodspecEphemeralContainersInnerSecurityContext.from_dict(obj.get("securityContext")) if obj.get("securityContext") is not None else None,
            "startupProbe": IoFissionV1EnvironmentSpecBuilderPodspecEphemeralContainersInnerLivenessProbe.from_dict(obj.get("startupProbe")) if obj.get("startupProbe") is not None else None,
            "stdin": obj.get("stdin"),
            ...
            "tty": obj.get("tty"),
            "volumeDevices": [IoFissionV1EnvironmentSpecBuilderContainerVolumeDevicesInner.from_dict(_item) for _item in obj.get("volumeDevices")] if obj.get("volumeDevices") is not None else None,
            "volumeMounts": [IoFissionV1EnvironmentSpecBuilderContainerVolumeMountsInner.from_dict(_item) for _item in obj.get("volumeMounts")] if obj.get("volumeMounts") is not None else None,
