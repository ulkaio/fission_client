...
class IoFissionV1EnvironmentSpecRuntime(BaseModel):
    """
    Runtime is configuration for running function, like container image etc.
    """ # noqa: E501
    container: Optional[IoFissionV1EnvironmentSpecRuntimeContainer] = None
    image: StrictStr = Field(description="Image for containing the language runtime.")
    podspec: Optional[IoFissionV1EnvironmentSpecRuntimePodspec] = None
    __properties: ClassVar[List[str]] = ["container", "image", "podspec"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "container": IoFissionV1EnvironmentSpecRuntimeContainer.from_dict(obj.get("container")) if obj.get("container") is not None else None,
            "image": obj.get("image"),
            "podspec": IoFissionV1EnvironmentSpecRuntimePodspec.from_dict(obj.get("podspec")) if obj.get("podspec") is not None else None
        })
        return _obj
