...
class IoFissionV1EnvironmentSpecBuilderPodspecVolumesInnerRbd(BaseModel):
    """
    ...
    secret_ref: Optional[IoFissionV1EnvironmentSpecBuilderPodspecVolumesInnerRbdSecretRef] = Field(default=None, alias="secretRef")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "secretRef": IoFissionV1EnvironmentSpecBuilderPodspecVolumesInnerRbdSecretRef.from_dict(obj.get("secretRef")) if obj.get("secretRef") is not None else None,
            "user": obj.get("user")
        })
        return _obj
