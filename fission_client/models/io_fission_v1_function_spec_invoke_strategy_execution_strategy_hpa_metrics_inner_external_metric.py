...
class IoFissionV1FunctionSpecInvokeStrategyExecutionStrategyHpaMetricsInnerExternalMetric(BaseModel):
    """
    metric identifies the target metric by name and selector
    """ # noqa: E501
    name: StrictStr = Field(description="name is the name of the given metric")
    selector: Optional[IoFissionV1FunctionSpecInvokeStrategyExecutionStrategyHpaMetricsInnerExternalMetricSelector] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "selector": IoFissionV1FunctionSpecInvokeStrategyExecutionStrategyHpaMetricsInnerExternalMetricSelector.from_dict(obj.get("selector")) if obj.get("selector") is not None else None
        })
        return _obj
