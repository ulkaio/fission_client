...
class IoFissionV1KubernetesWatchTriggerSpec(BaseModel):
    """
    KubernetesWatchTriggerSpec defines spec of KuberenetesWatchTrigger
    """ # noqa: E501
    functionref: IoFissionV1KubernetesWatchTriggerSpecFunctionref
    labelselector: Optional[Dict[str, StrictStr]] = Field(default=None, description="Resource labels")
    namespace: StrictStr
    type: StrictStr = Field(description="Type of resource to watch (Pod, Service, etc.)")
    __properties: ClassVar[List[str]] = ["functionref", "labelselector", "namespace", "type"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "functionref": IoFissionV1KubernetesWatchTriggerSpecFunctionref.from_dict(obj.get("functionref")) if obj.get("functionref") is not None else None,
