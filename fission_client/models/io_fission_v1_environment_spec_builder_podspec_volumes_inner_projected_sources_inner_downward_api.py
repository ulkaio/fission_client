...
class IoFissionV1EnvironmentSpecBuilderPodspecVolumesInnerProjectedSourcesInnerDownwardAPI(BaseModel):
    """
    downwardAPI information about the downwardAPI data to project
    """ # noqa: E501
    items: Optional[List[IoFissionV1EnvironmentSpecBuilderPodspecVolumesInnerDownwardAPIItemsInner]] = Field(default=None, description="Items is a list of DownwardAPIVolume file")
