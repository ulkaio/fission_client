...
class IoFissionV1FunctionSpecInvokeStrategyExecutionStrategyHpaMetricsInner(BaseModel):
    """
    MetricSpec specifies how to scale based on a single metric (only `type` and one other matching field should be set at once).
    """ # noqa: E501
    container_resource: Optional[IoFissionV1FunctionSpecInvokeStrategyExecutionStrategyHpaMetricsInnerContainerResource] = Field(default=None, alias="containerResource")
    external: Optional[IoFissionV1FunctionSpecInvokeStrategyExecutionStrategyHpaMetricsInnerExternal] = None
    object: Optional[IoFissionV1FunctionSpecInvokeStrategyExecutionStrategyHpaMetricsInnerObject] = None
    pods: Optional[IoFissionV1FunctionSpecInvokeStrategyExecutionStrategyHpaMetricsInnerPods] = None
    resource: Optional[IoFissionV1FunctionSpecInvokeStrategyExecutionStrategyHpaMetricsInnerResource] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "containerResource": IoFissionV1FunctionSpecInvokeStrategyExecutionStrategyHpaMetricsInnerContainerResource.from_dict(obj.get("containerResource")) if obj.get("containerResource") is not None else None,
            "external": IoFissionV1FunctionSpecInvokeStrategyExecutionStrategyHpaMetricsInnerExternal.from_dict(obj.get("external")) if obj.get("external") is not None else None,
            "object": IoFissionV1FunctionSpecInvokeStrategyExecutionStrategyHpaMetricsInnerObject.from_dict(obj.get("object")) if obj.get("object") is not None else None,
            "pods": IoFissionV1FunctionSpecInvokeStrategyExecutionStrategyHpaMetricsInnerPods.from_dict(obj.get("pods")) if obj.get("pods") is not None else None,
            "resource": IoFissionV1FunctionSpecInvokeStrategyExecutionStrategyHpaMetricsInnerResource.from_dict(obj.get("resource")) if obj.get("resource") is not None else None,
            "type": obj.get("type")
        })
        return _obj
