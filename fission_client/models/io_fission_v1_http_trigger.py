...
class IoFissionV1HTTPTrigger(BaseModel):
    """
    ...
    spec: IoFissionV1HTTPTriggerSpec
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "spec": IoFissionV1HTTPTriggerSpec.from_dict(obj.get("spec")) if obj.get("spec") is not None else None
        })
        return _obj
