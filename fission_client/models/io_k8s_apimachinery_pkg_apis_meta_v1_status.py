...
class IoK8sApimachineryPkgApisMetaV1Status(BaseModel):
    ...
    details: Optional[IoK8sApimachineryPkgApisMetaV1StatusDetails] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "code": obj.get("code"),
            "details": IoK8sApimachineryPkgApisMetaV1StatusDetails.from_dict(obj.get("details")) if obj.get("details") is not None else None,
            "kind": obj.get("kind"),
