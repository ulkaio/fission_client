...
class IoFissionV1KubernetesWatchTrigger(BaseModel):
    """
    ...
    spec: IoFissionV1KubernetesWatchTriggerSpec
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "spec": IoFissionV1KubernetesWatchTriggerSpec.from_dict(obj.get("spec")) if obj.get("spec") is not None else None
        })
        return _obj
