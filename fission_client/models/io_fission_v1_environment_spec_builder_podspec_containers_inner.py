...
class IoFissionV1EnvironmentSpecBuilderPodspecContainersInner(BaseModel):
    """
    ...
    lifecycle: Optional[IoFissionV1EnvironmentSpecBuilderContainerLifecycle] = None
    liveness_probe: Optional[IoFissionV1EnvironmentSpecBuilderContainerLivenessProbe] = Field(default=None, alias="livenessProbe")
    ...
    ports: Optional[List[IoFissionV1EnvironmentSpecBuilderContainerPortsInner]] = Field(default=None, description="List of ports to expose from the container. Not specifying a port here DOES NOT prevent that port from being exposed. Any port which is listening on the default \"0.0.0.0\" address inside a container will be accessible from the network. Modifying this array with strategic merge patch may corrupt the data. For more information See https://github.com/kubernetes/kubernetes/issues/108255. Cannot be updated.")
    readiness_probe: Optional[IoFissionV1EnvironmentSpecBuilderContainerReadinessProbe] = Field(default=None, alias="readinessProbe")
    ...
    resources: Optional[IoFissionV1EnvironmentSpecBuilderContainerResources] = None
    ...
    security_context: Optional[IoFissionV1EnvironmentSpecBuilderContainerSecurityContext] = Field(default=None, alias="securityContext")
    startup_probe: Optional[IoFissionV1EnvironmentSpecBuilderContainerStartupProbe] = Field(default=None, alias="startupProbe")
    ...
    volume_mounts: Optional[List[IoFissionV1EnvironmentSpecBuilderContainerVolumeMountsInner]] = Field(default=None, description="Pod volumes to mount into the container's filesystem. Cannot be updated.", alias="volumeMounts")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "lifecycle": IoFissionV1EnvironmentSpecBuilderContainerLifecycle.from_dict(obj.get("lifecycle")) if obj.get("lifecycle") is not None else None,
            "livenessProbe": IoFissionV1EnvironmentSpecBuilderContainerLivenessProbe.from_dict(obj.get("livenessProbe")) if obj.get("livenessProbe") is not None else None,
            "name": obj.get("name"),
            ...
            "readinessProbe": IoFissionV1EnvironmentSpecBuilderContainerReadinessProbe.from_dict(obj.get("readinessProbe")) if obj.get("readinessProbe") is not None else None,
            ...
            "resources": IoFissionV1EnvironmentSpecBuilderContainerResources.from_dict(obj.get("resources")) if obj.get("resources") is not None else None,
            "restartPolicy": obj.get("restartPolicy"),
            "securityContext": IoFissionV1EnvironmentSpecBuilderContainerSecurityContext.from_dict(obj.get("securityContext")) if obj.get("securityContext") is not None else None,
            "startupProbe": IoFissionV1EnvironmentSpecBuilderContainerStartupProbe.from_dict(obj.get("startupProbe")) if obj.get("startupProbe") is not None else None,
            "stdin": obj.get("stdin"),
