...
class IoFissionV1Environment(BaseModel):
    """
    ...
    spec: IoFissionV1EnvironmentSpec
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "spec": IoFissionV1EnvironmentSpec.from_dict(obj.get("spec")) if obj.get("spec") is not None else None
        })
        return _obj
