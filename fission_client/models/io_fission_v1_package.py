...
class IoFissionV1Package(BaseModel):
    """
    ...
    spec: IoFissionV1PackageSpec
    status: Optional[IoFissionV1PackageStatus] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "spec": IoFissionV1PackageSpec.from_dict(obj.get("spec")) if obj.get("spec") is not None else None,
            "status": IoFissionV1PackageStatus.from_dict(obj.get("status")) if obj.get("status") is not None else None
        })
        return _obj
