...
class IoFissionV1EnvironmentSpecBuilderPodspecVolumesInnerIscsi(BaseModel):
    """
    ...
    secret_ref: Optional[IoFissionV1EnvironmentSpecBuilderPodspecVolumesInnerIscsiSecretRef] = Field(default=None, alias="secretRef")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "secretRef": IoFissionV1EnvironmentSpecBuilderPodspecVolumesInnerIscsiSecretRef.from_dict(obj.get("secretRef")) if obj.get("secretRef") is not None else None,
