...
class IoFissionV1EnvironmentSpecBuilderPodspecVolumesInnerDownwardAPIItemsInner(BaseModel):
    """
    DownwardAPIVolumeFile represents information to create the file containing the pod field
    """ # noqa: E501
    field_ref: Optional[IoFissionV1EnvironmentSpecBuilderPodspecVolumesInnerDownwardAPIItemsInnerFieldRef] = Field(default=None, alias="fieldRef")
    ...
    resource_field_ref: Optional[IoFissionV1EnvironmentSpecBuilderPodspecVolumesInnerDownwardAPIItemsInnerResourceFieldRef] = Field(default=None, alias="resourceFieldRef")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "fieldRef": IoFissionV1EnvironmentSpecBuilderPodspecVolumesInnerDownwardAPIItemsInnerFieldRef.from_dict(obj.get("fieldRef")) if obj.get("fieldRef") is not None else None,
            "mode": obj.get("mode"),
            "path": obj.get("path"),
            "resourceFieldRef": IoFissionV1EnvironmentSpecBuilderPodspecVolumesInnerDownwardAPIItemsInnerResourceFieldRef.from_dict(obj.get("resourceFieldRef")) if obj.get("resourceFieldRef") is not None else None
        })
        return _obj
