...
class IoFissionV1EnvironmentSpecBuilderContainerEnvFromInner(BaseModel):
    """
    EnvFromSource represents the source of a set of ConfigMaps
    """ # noqa: E501
    config_map_ref: Optional[IoFissionV1EnvironmentSpecBuilderContainerEnvFromInnerConfigMapRef] = Field(default=None, alias="configMapRef")
    ...
    secret_ref: Optional[IoFissionV1EnvironmentSpecBuilderContainerEnvFromInnerSecretRef] = Field(default=None, alias="secretRef")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "configMapRef": IoFissionV1EnvironmentSpecBuilderContainerEnvFromInnerConfigMapRef.from_dict(obj.get("configMapRef")) if obj.get("configMapRef") is not None else None,
            "prefix": obj.get("prefix"),
            "secretRef": IoFissionV1EnvironmentSpecBuilderContainerEnvFromInnerSecretRef.from_dict(obj.get("secretRef")) if obj.get("secretRef") is not None else None
        })
        return _obj
