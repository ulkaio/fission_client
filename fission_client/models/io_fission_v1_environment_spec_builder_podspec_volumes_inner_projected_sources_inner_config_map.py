...
class IoFissionV1EnvironmentSpecBuilderPodspecVolumesInnerProjectedSourcesInnerConfigMap(BaseModel):
    """
    configMap information about the configMap data to project
    """ # noqa: E501
    items: Optional[List[IoFissionV1EnvironmentSpecBuilderPodspecVolumesInnerConfigMapItemsInner]] = Field(default=None, description="items if unspecified, each key-value pair in the Data field of the referenced ConfigMap will be projected into the volume as a file whose name is the key and content is the value. If specified, the listed keys will be projected into the specified paths, and unlisted keys will not be present. If a key is specified which is not present in the ConfigMap, the volume setup will error unless it is marked optional. Paths must be relative and may not contain the '..' path or start with '..'.")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "items": [IoFissionV1EnvironmentSpecBuilderPodspecVolumesInnerConfigMapItemsInner.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
            "name": obj.get("name"),
