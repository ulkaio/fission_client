...
class TestIoFissionV1EnvironmentSpecBuilderContainerEnvInner(unittest.TestCase):
    """IoFissionV1EnvironmentSpecBuilderContainerEnvInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IoFissionV1EnvironmentSpecBuilderContainerEnvInner:
        """Test IoFissionV1EnvironmentSpecBuilderContainerEnvInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IoFissionV1EnvironmentSpecBuilderContainerEnvInner`
        """
        model = IoFissionV1EnvironmentSpecBuilderContainerEnvInner()
        if include_optional:
            return IoFissionV1EnvironmentSpecBuilderContainerEnvInner(
                name = '',
                value = '',
    ...
    def testIoFissionV1EnvironmentSpecBuilderContainerEnvInner(self):
        """Test IoFissionV1EnvironmentSpecBuilderContainerEnvInner"""
