...
class TestIoFissionV1EnvironmentSpecBuilderPodspecEphemeralContainersInner(unittest.TestCase):
    """IoFissionV1EnvironmentSpecBuilderPodspecEphemeralContainersInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IoFissionV1EnvironmentSpecBuilderPodspecEphemeralContainersInner:
        """Test IoFissionV1EnvironmentSpecBuilderPodspecEphemeralContainersInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IoFissionV1EnvironmentSpecBuilderPodspecEphemeralContainersInner`
        """
        model = IoFissionV1EnvironmentSpecBuilderPodspecEphemeralContainersInner()
        if include_optional:
            return IoFissionV1EnvironmentSpecBuilderPodspecEphemeralContainersInner(
                args = [
                    ''
                    ],
                command = [
                ...
                security_context = fission_client.models.io_fission_v1_environment_spec_builder_podspec_ephemeral_containers_inner_security_context.io_fission_v1_Environment_spec_builder_podspec_ephemeralContainers_inner_securityContext(
                    ...
                    windows_options = fission_client.models.io_fission_v1_environment_spec_builder_container_security_context_windows_options.io_fission_v1_Environment_spec_builder_container_securityContext_windowsOptions(
                        ...
                        host_process = True, 
                        run_as_user_name = '', ), ),
                startup_probe = fission_client.models.io_fission_v1_environment_spec_builder_podspec_ephemeral_containers_inner_liveness_probe.io_fission_v1_Environment_spec_builder_podspec_ephemeralContainers_inner_livenessProbe(
                    exec = fission_client.models.io_fission_v1_environment_spec_builder_container_lifecycle_post_start_exec.io_fission_v1_Environment_spec_builder_container_lifecycle_postStart_exec(
                        command = [
                            ''
                            ], ), 
    ...
    def testIoFissionV1EnvironmentSpecBuilderPodspecEphemeralContainersInner(self):
        """Test IoFissionV1EnvironmentSpecBuilderPodspecEphemeralContainersInner"""
