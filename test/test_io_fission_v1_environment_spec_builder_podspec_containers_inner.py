...
class TestIoFissionV1EnvironmentSpecBuilderPodspecContainersInner(unittest.TestCase):
    """IoFissionV1EnvironmentSpecBuilderPodspecContainersInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IoFissionV1EnvironmentSpecBuilderPodspecContainersInner:
        """Test IoFissionV1EnvironmentSpecBuilderPodspecContainersInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IoFissionV1EnvironmentSpecBuilderPodspecContainersInner`
        """
        model = IoFissionV1EnvironmentSpecBuilderPodspecContainersInner()
        if include_optional:
            return IoFissionV1EnvironmentSpecBuilderPodspecContainersInner(
                args = [
                    ''
                    ],
                command = [
    ...
    def testIoFissionV1EnvironmentSpecBuilderPodspecContainersInner(self):
        """Test IoFissionV1EnvironmentSpecBuilderPodspecContainersInner"""
