...
class TestIoK8sApimachineryPkgApisMetaV1ServerAddressByClientCIDR(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> IoK8sApimachineryPkgApisMetaV1ServerAddressByClientCIDR:
        """Test IoK8sApimachineryPkgApisMetaV1ServerAddressByClientCIDR
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IoK8sApimachineryPkgApisMetaV1ServerAddressByClientCIDR`
        """
        model = IoK8sApimachineryPkgApisMetaV1ServerAddressByClientCIDR()
        if include_optional:
