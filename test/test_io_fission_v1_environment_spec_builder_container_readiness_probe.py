...
class TestIoFissionV1EnvironmentSpecBuilderContainerReadinessProbe(unittest.TestCase):
    """IoFissionV1EnvironmentSpecBuilderContainerReadinessProbe unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IoFissionV1EnvironmentSpecBuilderContainerReadinessProbe:
        """Test IoFissionV1EnvironmentSpecBuilderContainerReadinessProbe
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IoFissionV1EnvironmentSpecBuilderContainerReadinessProbe`
        """
        model = IoFissionV1EnvironmentSpecBuilderContainerReadinessProbe()
        if include_optional:
            return IoFissionV1EnvironmentSpecBuilderContainerReadinessProbe(
    ...
    def testIoFissionV1EnvironmentSpecBuilderContainerReadinessProbe(self):
        """Test IoFissionV1EnvironmentSpecBuilderContainerReadinessProbe"""
