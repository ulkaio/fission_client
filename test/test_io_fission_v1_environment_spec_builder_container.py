...
class TestIoFissionV1EnvironmentSpecBuilderContainer(unittest.TestCase):
    """IoFissionV1EnvironmentSpecBuilderContainer unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IoFissionV1EnvironmentSpecBuilderContainer:
        """Test IoFissionV1EnvironmentSpecBuilderContainer
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IoFissionV1EnvironmentSpecBuilderContainer`
        """
        model = IoFissionV1EnvironmentSpecBuilderContainer()
        if include_optional:
            return IoFissionV1EnvironmentSpecBuilderContainer(
                args = [
                    ''
                    ],
                command = [
    ...
    def testIoFissionV1EnvironmentSpecBuilderContainer(self):
        """Test IoFissionV1EnvironmentSpecBuilderContainer"""
