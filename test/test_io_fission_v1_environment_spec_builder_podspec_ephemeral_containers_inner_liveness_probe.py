...
class TestIoFissionV1EnvironmentSpecBuilderPodspecEphemeralContainersInnerLivenessProbe(unittest.TestCase):
    """IoFissionV1EnvironmentSpecBuilderPodspecEphemeralContainersInnerLivenessProbe unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IoFissionV1EnvironmentSpecBuilderPodspecEphemeralContainersInnerLivenessProbe:
        """Test IoFissionV1EnvironmentSpecBuilderPodspecEphemeralContainersInnerLivenessProbe
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IoFissionV1EnvironmentSpecBuilderPodspecEphemeralContainersInnerLivenessProbe`
        """
        model = IoFissionV1EnvironmentSpecBuilderPodspecEphemeralContainersInnerLivenessProbe()
        if include_optional:
            return IoFissionV1EnvironmentSpecBuilderPodspecEphemeralContainersInnerLivenessProbe(
    ...
    def testIoFissionV1EnvironmentSpecBuilderPodspecEphemeralContainersInnerLivenessProbe(self):
        """Test IoFissionV1EnvironmentSpecBuilderPodspecEphemeralContainersInnerLivenessProbe"""
