...
class TestIoFissionV1EnvironmentSpecBuilderContainerLivenessProbe(unittest.TestCase):
    """IoFissionV1EnvironmentSpecBuilderContainerLivenessProbe unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IoFissionV1EnvironmentSpecBuilderContainerLivenessProbe:
        """Test IoFissionV1EnvironmentSpecBuilderContainerLivenessProbe
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IoFissionV1EnvironmentSpecBuilderContainerLivenessProbe`
        """
        model = IoFissionV1EnvironmentSpecBuilderContainerLivenessProbe()
        if include_optional:
            return IoFissionV1EnvironmentSpecBuilderContainerLivenessProbe(
    ...
    def testIoFissionV1EnvironmentSpecBuilderContainerLivenessProbe(self):
        """Test IoFissionV1EnvironmentSpecBuilderContainerLivenessProbe"""
