...
io_k8s_apimachinery_pkg_apis_meta_v1_object_meta_form_dict = io_k8s_apimachinery_pkg_apis_meta_v1_object_meta.from_dict(io_k8s_apimachinery_pkg_apis_meta_v1_object_meta_dict)
```
