...
**lifecycle** | [**IoFissionV1EnvironmentSpecBuilderPodspecEphemeralContainersInnerLifecycle**](IoFissionV1EnvironmentSpecBuilderPodspecEphemeralContainersInnerLifecycle.md) |  | [optional] 
**liveness_probe** | [**IoFissionV1EnvironmentSpecBuilderPodspecEphemeralContainersInnerLivenessProbe**](IoFissionV1EnvironmentSpecBuilderPodspecEphemeralContainersInnerLivenessProbe.md) |  | [optional] 
...
**ports** | [**List[IoFissionV1EnvironmentSpecBuilderContainerPortsInner]**](IoFissionV1EnvironmentSpecBuilderContainerPortsInner.md) | Ports are not allowed for ephemeral containers. | [optional] 
**readiness_probe** | [**IoFissionV1EnvironmentSpecBuilderPodspecEphemeralContainersInnerLivenessProbe**](IoFissionV1EnvironmentSpecBuilderPodspecEphemeralContainersInnerLivenessProbe.md) |  | [optional] 
...
**resources** | [**IoFissionV1EnvironmentSpecBuilderPodspecEphemeralContainersInnerResources**](IoFissionV1EnvironmentSpecBuilderPodspecEphemeralContainersInnerResources.md) |  | [optional] 
...
**security_context** | [**IoFissionV1EnvironmentSpecBuilderPodspecEphemeralContainersInnerSecurityContext**](IoFissionV1EnvironmentSpecBuilderPodspecEphemeralContainersInnerSecurityContext.md) |  | [optional] 
**startup_probe** | [**IoFissionV1EnvironmentSpecBuilderPodspecEphemeralContainersInnerLivenessProbe**](IoFissionV1EnvironmentSpecBuilderPodspecEphemeralContainersInnerLivenessProbe.md) |  | [optional] 
...
**volume_mounts** | [**List[IoFissionV1EnvironmentSpecBuilderContainerVolumeMountsInner]**](IoFissionV1EnvironmentSpecBuilderContainerVolumeMountsInner.md) | Pod volumes to mount into the container&#39;s filesystem. Subpath mounts are not allowed for ephemeral containers. Cannot be updated. | [optional] 
...
json = "{}"
# create an instance of IoFissionV1EnvironmentSpecBuilderPodspecEphemeralContainersInner from a JSON string
io_fission_v1_environment_spec_builder_podspec_ephemeral_containers_inner_instance = IoFissionV1EnvironmentSpecBuilderPodspecEphemeralContainersInner.from_json(json)
# print the JSON string representation of the object
print IoFissionV1EnvironmentSpecBuilderPodspecEphemeralContainersInner.to_json()

# convert the object into a dict
io_fission_v1_environment_spec_builder_podspec_ephemeral_containers_inner_dict = io_fission_v1_environment_spec_builder_podspec_ephemeral_containers_inner_instance.to_dict()
# create an instance of IoFissionV1EnvironmentSpecBuilderPodspecEphemeralContainersInner from a dict
io_fission_v1_environment_spec_builder_podspec_ephemeral_containers_inner_form_dict = io_fission_v1_environment_spec_builder_podspec_ephemeral_containers_inner.from_dict(io_fission_v1_environment_spec_builder_podspec_ephemeral_containers_inner_dict)
```
